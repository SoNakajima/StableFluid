...
void setup() {
  ...
  cp5.addSlider("dt", 0.00000001, 1.0, 0.4, 70, 400, 100, 15);
  cp5.addSlider("adj", 0.00000001, 0.25, 0.15, 70, 420, 100, 15);
  cp5.addSlider("shift",-1,1,0,70,440,100,15);
}
void draw() {
  ...
  fill(255);
  textSize(15);
  text("Press R to random mode",70,473);
  fill(0, 255, 0);
  textSize(15);
  ...
  textSize(35);
  fill(255);
  if(shift>0) text("HEADER",315,45);
  if(shift<0) text("LIFT",345,45);
